...
def main(args):
    ...
    eval_every = 200000  # to avoid evaluation
    ...
    for rollout_id in range(num_rollouts):
        ...
        with torch.inference_mode():
            ...
            for t in range(max_timesteps):
                ...
                # here is the error, what the fuck. fuck you.
                # Err reason: the qpos_numpy is from the sim envrionment,
                # and the state dim is 14 in the sim environment.
                # sim environment is used in evaluation  
